...
<div class='container'>
    ...
    <div class="row">
            ...
            <?php if($iPhone || $windows || $mac || $iPad) { ?>
            <a target="blank" href="https://itunes.apple.com/us/app/boom-artist/id1064352686?ls=1&mt=8">
                    <p class='button-app'><img class='img-responsive' src="<?php echo $siteUrl.'/images/iphone.png'; ?>"></p>
            </a>
            </div>    
            <div class="col-xs-6 button-apps">    
            <?php } if($Android || $windows || $mac) { ?>
            <a target="blank" href="https://play.google.com/store/apps/details?id=com.boomuserapp">
