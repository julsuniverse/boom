 ...
 */
class Flagged extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ArtistID','IsExclusive','IsShared','PostType','Description','Status'], 'required','on'=>'create'],
            [['IsExclusive','IsShared','Description','Status'], 'required','on'=>'update'],
